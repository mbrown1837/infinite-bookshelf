...
st.write(
    """
# Infinite Bookshelf: Write full books using Together AI LLMs
"""
)
...
try:
    ...
    submitted, together_input_key, topic_text, additional_instructions = render_together_form(
        on_submit=disable,
    ...
    if submitted:
        ...
        total_generation_statistics = GenerationStatistics(model_name="together-7b")
